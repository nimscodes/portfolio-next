    ...
    return (
        <div className='max-w-[1240px] w-[90%] h-screen  p-2 flex justify-center items-center mx-auto'>
            <div className='md:w-[85%] flex flex-col p-2 gap-5'>
                ...
                <p className='text-gray-600 py-2 max-w-[70%] md:text-md font-light'>I am a front-end web developer specializing in building exceptional UI. Currently, I&apos;m focused on building responsive
